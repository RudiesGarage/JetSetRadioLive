...
class C0162c {
    ...
    public static class C0161b {
        ...
        C0161b(C0161b c0161b) {
            this.f381a = c0161b.f381a;
            this.f382b = C0162c.m538a(c0161b.f382b, 0, c0161b.f382b.length);
        }

        public static void m534a(C0161b[] c0161bArr, Path path) {
            float[] fArr = new float[6];
            char c = 'm';
            for (int i = 0; i < c0161bArr.length; i++) {
                C0161b.m533a(path, fArr, c, c0161bArr[i].f381a, c0161bArr[i].f382b);
                c = c0161bArr[i].f381a;
            }
        }

        private static void m533a(Path path, float[] fArr, char c, char c2, float[] fArr2) {
            int i;
            float f = fArr[0];
            float f2 = fArr[1];
            float f3 = fArr[2];
            ...
            while (i2 < fArr2.length) {
                ...
                switch (c2) {
                    case 'A':
                        ...
                        C0161b.m532a(path, f10, f9, f5, f2, f, f11, f12, z, z2);
                        f3 = fArr2[i2 + 5];
                        f4 = fArr2[i2 + 6];
                        f6 = f7;
                        f5 = f8;
        ...
        private static void m532a(Path path, float f, float f2, float f3, float f4, float f5, float f6, float f7, boolean z, boolean z2) {
            ...
            if (d10 < 0.0d) {
                ...
                C0161b.m532a(path, f, f2, f3, f4, f5 * sqrt, f6 * sqrt, f7, z, z2);
                return;
            }
            d9 = Math.sqrt(d10);
            d5 *= d9;
            ...
            d = ((double) f5) * d6;
            d5 *= (double) f6;
            C0161b.m531a(path, (d * cos) - (d5 * sin), (d * sin) + (d5 * cos), (double) f5, (double) f6, (double) f, (double) f2, toRadians, d7, d4);
        }

        private static void m531a(Path path, double d, double d2, double d3, double d4, double d5, double d6, double d7, double d8, double d9) {
    ...
    static float[] m538a(float[] fArr, int i, int i2) {
        if (i > i2) {
    ...
    public static C0161b[] m539a(String str) {
        if (str == null) {
            return null;
        }
        ...
        int i2 = 0;
        while (i < str.length()) {
            int a = C0162c.m535a(str, i);
            String trim = str.substring(i2, a).trim();
            if (trim.length() > 0) {
                C0162c.m537a(arrayList, trim.charAt(0), C0162c.m541b(trim));
            }
            i = a + 1;
            i2 = a;
        }
        if (i - i2 == 1 && i2 < str.length()) {
            C0162c.m537a(arrayList, str.charAt(i2), new float[0]);
        }
        return (C0161b[]) arrayList.toArray(new C0161b[arrayList.size()]);
    }

    public static C0161b[] m540a(C0161b[] c0161bArr) {
        if (c0161bArr == null) {
            return null;
        }
    ...
    private static int m535a(String str, int i) {
        while (i < str.length()) {
    ...
    private static void m537a(ArrayList<C0161b> arrayList, char c, float[] fArr) {
        arrayList.add(new C0161b(c, fArr));
    }

    private static float[] m541b(String str) {
    ...
    private static void m536a(java.lang.String r7, int r8, android.support.p013a.p014a.C0162c.C0160a r9) {
        /*
        r1 = 0;
        r5 = 1;
        r9.f380b = r1;
