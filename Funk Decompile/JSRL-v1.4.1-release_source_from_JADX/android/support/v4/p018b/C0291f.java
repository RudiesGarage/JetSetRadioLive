...
public final class C0291f {
    private static final Object f775f = new Object();
    private static C0291f f776g;
    private final Context f777a;
    private final HashMap<BroadcastReceiver, ArrayList<IntentFilter>> f778b = new HashMap();
    private final HashMap<String, ArrayList<C0290b>> f779c = new HashMap();
    private final ArrayList<C0289a> f780d = new ArrayList();
    private final Handler f781e;

    /* compiled from: LocalBroadcastManager */
    private static class C0289a {
        final Intent f770a;
        final ArrayList<C0290b> f771b;

        C0289a(Intent intent, ArrayList<C0290b> arrayList) {
            this.f770a = intent;
    ...
    private static class C0290b {
        final IntentFilter f772a;
        final BroadcastReceiver f773b;
        boolean f774c;

        C0290b(IntentFilter intentFilter, BroadcastReceiver broadcastReceiver) {
            this.f772a = intentFilter;
            this.f773b = broadcastReceiver;
        }

        public String toString() {
            StringBuilder stringBuilder = new StringBuilder(128);
            stringBuilder.append("Receiver{");
            stringBuilder.append(this.f773b);
            stringBuilder.append(" filter=");
            stringBuilder.append(this.f772a);
            stringBuilder.append("}");
            return stringBuilder.toString();
        }
    }

    public static C0291f m1084a(Context context) {
        C0291f c0291f;
        synchronized (f775f) {
            if (f776g == null) {
                f776g = new C0291f(context.getApplicationContext());
            }
            c0291f = f776g;
        }
        return c0291f;
    ...
    private C0291f(Context context) {
        this.f777a = context;
        this.f781e = new Handler(this, context.getMainLooper()) {
            final /* synthetic */ C0291f f769a;
    ...
    public void m1087a(BroadcastReceiver broadcastReceiver, IntentFilter intentFilter) {
        synchronized (this.f778b) {
            C0290b c0290b = new C0290b(intentFilter, broadcastReceiver);
            ArrayList arrayList = (ArrayList) this.f778b.get(broadcastReceiver);
            if (arrayList == null) {
                arrayList = new ArrayList(1);
                this.f778b.put(broadcastReceiver, arrayList);
            }
            arrayList.add(intentFilter);
            for (int i = 0; i < intentFilter.countActions(); i++) {
                String action = intentFilter.getAction(i);
                arrayList = (ArrayList) this.f779c.get(action);
                if (arrayList == null) {
                    arrayList = new ArrayList(1);
                    this.f779c.put(action, arrayList);
                }
    ...
    public boolean m1088a(android.content.Intent r17) {
        /*
        r16 = this;
        r0 = r16;
        r13 = r0.f778b;
    ...
    L_0x0092:
        ...
        r0 = r1;
        r0 = (android.support.v4.p018b.C0291f.C0290b) r0;	 Catch:{ all -> 0x0103 }
        r9 = r0;
    ...
    L_0x009c:
        ...
        r14 = r9.f772a;	 Catch:{ all -> 0x0103 }
        r7 = r7.append(r14);	 Catch:{ all -> 0x0103 }
        r7 = r7.toString();	 Catch:{ all -> 0x0103 }
        android.util.Log.v(r1, r7);	 Catch:{ all -> 0x0103 }
    L_0x00b6:
        r1 = r9.f774c;	 Catch:{ all -> 0x0103 }
    ...
    L_0x013d:
        ...
        r1 = (android.support.v4.p018b.C0291f.C0290b) r1;	 Catch:{ all -> 0x0103 }
        r3 = 0;
        r1.f774c = r3;	 Catch:{ all -> 0x0103 }
        r1 = r2 + 1;
        r2 = r1;
        goto L_0x0137;
    L_0x014a:
        r0 = r16;
        r1 = r0.f780d;	 Catch:{ all -> 0x0103 }
        r2 = new android.support.v4.b.f$a;	 Catch:{ all -> 0x0103 }
        r0 = r17;
        r2.<init>(r0, r10);	 Catch:{ all -> 0x0103 }
        r1.add(r2);	 Catch:{ all -> 0x0103 }
        r0 = r16;
        r1 = r0.f781e;	 Catch:{ all -> 0x0103 }
        r2 = 1;
    ...
    L_0x0171:
        ...
        goto L_0x00fc;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.b.f.a(android.content.Intent):boolean");
    }
    ...
    L_0x000c:
        ...
        return;
    L_0x000e:
        r4 = new android.support.v4.p018b.C0291f.C0289a[r0];	 Catch:{ all -> 0x003f }
        r0 = r8.f780d;	 Catch:{ all -> 0x003f }
    ...
    L_0x002a:
        r0 = r5.f771b;
        r0 = r0.get(r1);
        r0 = (android.support.v4.p018b.C0291f.C0290b) r0;
        r0 = r0.f773b;
        r6 = r8.f777a;
        r7 = r5.f770a;
        r0.onReceive(r6, r7);
    ...
    L_0x0042:
        ...
        goto L_0x001c;
        */
        throw new UnsupportedOperationException("Method not decompiled: android.support.v4.b.f.a():void");
    }
}
