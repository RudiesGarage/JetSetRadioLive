...
public class C0218i extends Fragment implements OnCancelListener, OnDismissListener {
    ...
    public void show(C0226n c0226n, String str) {
        ...
        C0213r a = c0226n.mo142a();
        a.mo104a((Fragment) this, str);
        a.mo105b();
    }

    public int show(C0213r c0213r, String str) {
        this.mDismissed = false;
        this.mShownByMe = true;
        c0213r.mo104a((Fragment) this, str);
        this.mViewDestroyed = false;
        this.mBackStackId = c0213r.mo105b();
    ...
    void dismissInternal(boolean z) {
        if (!this.mDismissed) {
            ...
            if (this.mBackStackId >= 0) {
                getFragmentManager().mo144a(this.mBackStackId, 1);
                this.mBackStackId = -1;
                return;
            }
            C0213r a = getFragmentManager().mo142a();
            a.mo103a(this);
            if (z) {
                a.mo106c();
            } else {
    ...
    public LayoutInflater getLayoutInflater(Bundle bundle) {
        ...
        if (this.mDialog == null) {
            return (LayoutInflater) this.mHost.m742i().getSystemService("layout_inflater");
        }
